...
## Testing - Stage 2: Live Scrapping

Use Case JSON + Playwright Accessibility Snapshot (Live) → LLM → Playwright Test
...
- Download a suitable model (recommended: `Qwen2.5-Coder-14B`)
...
- Save the tests to:
  src/apps/weather-app/tests/stage_2_live_scrapping/
